...
from brewblox_remote_relay import http_example, publish_example, subscribe_example

LOGGER = brewblox_logger(__name__)


def create_parser(default_name='brewblox_remote_relay') -> ArgumentParser:
...
def main():
    ...
    #
    # The default value is "brewblox_remote_relay" (provided in service.create_app()).
    # This means you can now access the example/endpoint as "/brewblox_remote_relay/example/endpoint"
    service.furnish(app)
